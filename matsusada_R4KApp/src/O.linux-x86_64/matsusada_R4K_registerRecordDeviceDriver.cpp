...
/* Generated from ../O.Common/matsusada_R4K.dbd */
...
static const char * const deviceSupportNames[] = {
    ...
    "asynAiInt64", "devAiStats", "devAiClusts", "devAoSoft",
    "devAoSoftRaw", "devAoSoftCallback", "devaoStream", "asynAoInt32",
    "asynAoFloat64", "asynAoInt64", "devAoStats", "asynRecordDevice",
    ...
    "asynMbbiUInt32Digital", "devCasterMBBIState", "devMbbiDirectSoft",
    "devMbbiDirectSoftRaw", "devMbbiDirectSoftCallback",
    "devmbbiDirectStream", "asynMbbiDirectUInt32Digital", "devMbboSoft",
    "devMbboSoftRaw", "devMbboSoftCallback", "devmbboStream",
    "asynMbboInt32", "asynMbboUInt32Digital", "devMbboDirectSoft",
    "devMbboDirectSoftRaw", "devMbboDirectSoftCallback",
    "devmbboDirectStream", "asynMbboDirectUInt32Digital", "devPrintfSoft",
    ...
    "devStringinEnvVar", "devStringinEpics", "devCasterSIMsg",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_asynMbbiUInt32Digital, pvar_dset_devCasterMBBIState,
...
epicsShareExtern reg_func pvar_func_AsynDriverInterfaceRegistrar,
    pvar_func_QSRVRegistrar, pvar_func_aCalcMonitorMemRegister,
    ...
    pvar_func_reccasterRegistrar, pvar_func_refTrackRegistrar,
    ...
    pvar_func_register_func_aSub_R4K_80_STS_Init,
    pvar_func_register_func_aSub_R4K_80_STS_Proc,
...
int matsusada_R4K_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/nsls2/users/dgavrilov/repos/matsusada-R4K-ioc";
    ...
    runRegistrarOnce(pvar_func_register_func_aSub_R4K_80_STS_Init);
    runRegistrarOnce(pvar_func_register_func_aSub_R4K_80_STS_Proc);
...
/* matsusada_R4K_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"matsusada_R4K_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(matsusada_R4K_registerRecordDeviceDriver(*iocshPpdbbase));
}
